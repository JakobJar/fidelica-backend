...
import org.fidelica.backend.repository.repositories.article.StandardArticleEditRepository;
...
public class RepositoryModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(ArticleEditRepository.class).to(StandardArticleEditRepository.class).in(Scopes.SINGLETON);
